...
public class BubbleSortViewOld extends ViewGroup {
    ...
    public BubbleSortViewOld(Context context) {
        this(context, null);
    }

    public BubbleSortViewOld(Context context, AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public BubbleSortViewOld(Context context, AttributeSet attrs, int defStyleAttr) {
